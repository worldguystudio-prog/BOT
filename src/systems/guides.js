...
export const GUIDES = {
    ...
    embed(
      ...
      [
        { name: '📊 Available Guides', value: [
          ...
          '• **Joining ORGVNUM (Tryouts)** — how to apply and attend tryouts',
        ].join('\n'), inline: false },
  ...
  tryouts: () => [
    embed(
      '🚪 Joining ORGVNUM — The Tryout Path',
      `**Want to join ORGVNUM?** Here's the step-by-step path from "just found the server" to "official member."`,
      BRAND.colors.success,
      [
        { name: '📋 Step 1 — Submit a Recruitment Application', value: [
          'Go to the **#applications** channel and click the **[Recruitment]** button.',
          '',
          'The bot will DM you 5 questions:',
          '• Your Discord username',
          '• Your age',
          '• Your timezone',
          '• Any previous experience (optional)',
          '• Why you want to join ORGVNUM',
          '',
          'Answer each one honestly. The bot saves your answers and submits the application automatically.',
          '',
          '⚠️ **Make sure your DMs are open** — the bot needs to DM you the questions. If your DMs are closed, you\'ll get a popup form instead.',
        ].join('\n'), inline: false },
        { name: '⏳ Step 2 — Wait for Review', value: [
          'Your application goes to our recruitment team. They review it and decide:',
          '• **Accept** → you\'re invited to a tryout',
          '• **Deny** → you can reapply later (the denial note tells you when)',
          '• **Waitlist** → you\'re on the placement waitlist',
          '• **Interview** → a recruiter wants to talk to you first',
          '',
          'You\'ll get a DM when your status changes. **Don\'t message staff about your status unless asked.**',
        ].join('\n'), inline: false },
      ],
    ),
    embed(
      ...
      BRAND.colors.success,
      [
        { name: '🎯 Step 3 — Attend the Tryout', value: [
          'If your application is accepted, you\'ll be invited to a tryout session. Here\'s what happens:',
          '',
          '1. A trainer creates the event (you\'ll see it announced)',
          '2. Show up at the scheduled time in the specified voice/text channel',
          '3. The trainer runs you through basic training',
          '4. Your attendance is recorded',
          '5. You may be awarded points for attending',
          '',
          '**What to bring:**',
          '• A working microphone (if it\'s a voice tryout)',
          '• Readiness to participate',
          '• Respect for the trainers and other applicants',
        ].join('\n'), inline: false },
        { name: '✅ Step 4 — Pass and Get Placed', value: [
          'After the tryout:',
          '• The trainer marks your attendance',
          '• You may be assigned a callsign and department',
          '• You\'re now an official ORGVNUM member!',
          '',
          'Use `/profile` to see your new personnel file.',
        ].join('\n'), inline: false },
        { name: '🏆 Tips to Pass', value: [
          '• **Be on time.** Late = missed tryout.',
          '• **Listen to instructions.** Following directions > being perfect.',
          '• **Be respectful.** Toxic behavior = instant fail.',
          '• **Ask questions** if you\'re confused — trainers prefer that over silent mistakes.',
          '• **Have fun.** It\'s a game community, not a job interview.',
        ].join('\n'), inline: false },
      ],
    ),
    embed(
      '🚪 Tryouts — FAQ & Troubleshooting',
      null,
      BRAND.colors.success,
      [
        { name: '❓ Frequently Asked Questions', value: [
          '**Q: I didn\'t get a DM after clicking the button.**',
          'A: Your DMs are probably closed. Go to User Settings → Privacy → enable "Allow DMs from server members." Or use the popup form that appears.',
          '',
          '**Q: How long does review take?**',
          'A: Usually 24-48 hours. If it\'s been longer, you can open a ticket (General Support) to ask politely.',
          '',
          '**Q: I was denied. Can I reapply?**',
          'A: Yes — the denial DM tells you when. Usually 30 days. Use the time to improve whatever the denial note mentioned.',
          '',
          '**Q: I missed my tryout. What now?**',
          'A: Open a ticket (Roleplay Support or General Support). Trainers run tryouts regularly — you\'ll get another chance.',
          '',
          '**Q: Do I need previous experience?**',
          'A: No. The Recruitment application is for newcomers. We train you.',
        ].join('\n'), inline: false },
        { name: '🚫 What Gets You Denied', value: [
          '• Lying on your application (we check)',
          '• Toxic behavior in the server before applying',
          '• Being underage for the server\'s requirements',
          '• Incomplete or low-effort answers ("idk", "just want to join")',
          '• History of rule violations on your account',
        ].join('\n'), inline: false },
        { name: '📞 Need Help?', value: [
          'Open a ticket using the ticket panel in #support:',
          '• **General Support** — general questions',
          '• **Recruitment** — application-specific questions',
          '• **Roleplay Support** — if you\'re already a member and need RP help',
          '',
          'Staff are here to help. Don\'t be afraid to ask.',
        ].join('\n'), inline: false },
      ],
    ),
  ],
